...
#define LV_MEM_CUSTOM 1   /* Use system malloc — pool was too small for GIF canvases. */
#if LV_MEM_CUSTOM == 0
...
#if LV_USE_FS_STDIO
    #define LV_FS_STDIO_LETTER 'S'      /*"S:/path/to/file" routes to stdio*/
...
/*PNG decoder library (lodepng) — used for the buienradar radar image. */
#define LV_USE_PNG 1
